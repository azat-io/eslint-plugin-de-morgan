/**
 * Combines multiple predicate functions using logical OR (`||`).
 * The returned function returns `true` as soon as one predicate returns `true`.
 * Otherwise, it returns `false`.
 * @template T The argument types for the predicates.
 * @param {...((...args: T) => boolean)[]} predicates - The predicates to combine.
 * @returns {(...args: T) => boolean} A function that returns `true` if any predicate returns `true`, otherwise `false`.
 * @example
